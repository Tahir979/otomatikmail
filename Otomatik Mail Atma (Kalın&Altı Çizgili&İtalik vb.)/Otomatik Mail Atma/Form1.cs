    ...
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        void Emailgonder()
        {
            ...
            else
            {
                ...
                mail.Subject = "HÜPT IV. Ruh Sağlığı Sempozyumu Bilgilendirme Maili"; mail.IsBodyHtml = true; mail.Body = "Merhaba Sayın" + " " + txt_isim.Text.ToString() + "," + "<br/> <br/>" + "23 Mayıs Pazar günü saat 09.30’da açılış konuşmaları ile başlayıp saat 18.30’a kadar sürecek olan IV. Ruh Sağlığı Sempozyumumuzu düzenleyecek olmanın heyecanı içindeyiz." + "<br/> <br/>" + "Pazar günü gerçekleştireceğimiz sempozyum için zoom’a giriş yaparken " + "<b><u>kayıt formumuza yazmış olduğunuz isminizle girmeniz gerekmektedir. Kayıtlı olduğunuz isim ve soy isminiz ile zoom’a giriş yaptığınızdan lütfen emin olunuz.</u></b>" + " Sempozyum günü zooma olan girişler ekip üyelerimiz tarafından dikkatle incelenecek ve kayıtlı olmayan katılımcılar belirlenecektir." + "<br/> <br/>" + "Pazar günü yaşanabilecek olan olası aksaklıklar için hızlı bir şekilde iletişime geçebilmeniz adına ekip arkadaşımız Rabia Yetiş’in telefon numarasını size iletiyoruz. Kendisiyle öncelikle Whatsapp yoluyla iletişime geçmeniz önemle rica olunur." + "<br/> <br/>" + "Rabia Yetiş: 0537 464 23 98" + "<br/> <br/> <br/>" + "Pazar günü gün boyunca kullanılacak olan ve tüm katılımcı hocalarımızın konuşmalarını gerçekleştireceği zoom bağlantı linkini size iletiyoruz." + "<br/> <br/>" + "EDEBIYAT FAKULTESI PSIKOLOJI is inviting you to a scheduled Zoom meeting." + "<br/> <br/>" + " Topic: IV. Hacettepe Ruh Sağlığı Sempozyumu " + @" ""Belirsizlik"" " + "<br/>" + "Time: May 23, 2021 07:00 AM Istanbul" + "<br/> <br/>" + "Join Zoom Meeting" + "<br/>" + "https://zoom.us/j/97906910880?pwd=T1V0WXpZWHU4ZUUwajVjS2tJSTkxUT09" + "<br/> <br/>" + "Meeting ID: 979 0691 0880" + "<br/>" + "Passcode: 441463" + "<br/>" + "One tap mobile" + "<br/>" + "+12532158782,,97906910880#,,,,*441463# US (Tacoma)" + "<br/>" + "+13017158592,,97906910880#,,,,*441463# US (Washington DC)" + "<br/> <br/>" + "Dial by your location" + "<br/>" + "+1 253 215 8782 US (Tacoma)" + "<br/>" + "+1 301 715 8592 US (Washington DC)" + "<br/>" + "+1 312 626 6799 US (Chicago)" + "<br/>" + "+1 346 248 7799 US (Houston)" + "<br/>" + "+1 669 900 6833 US (San Jose)" + "<br/>" + "+1 929 436 2866 US (New York)" + "<br/>" + "Meeting ID: 979 0691 0880" + "<br/>" + "Passcode: 441463" + "<br/>" + "Find your local number: https://zoom.us/u/a75ImlmCg" + "<br/> <br/> <br/>" + "Sempozyumumuza olan İlginiz için teşekkür ederiz. Yarın görüşmek üzere!" + "<br/>" + "Hacettepe Üniversitesi Psikoloji Topluluğu";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            txt_kalinvecizgili.Font = new Font(txt_kalinvecizgili.Font, txt_kalinvecizgili.Font.Style ^ FontStyle.Bold);
            txt_kalinvecizgili.Font = new Font(txt_kalinvecizgili.Font, txt_kalinvecizgili.Font.Style ^ FontStyle.Underline);

            txt_kalinvecizgili.Text = "kayıt formumuza yazmış olduğunuz isminizle girmeniz gerekmektedir. Kayıtlı olduğunuz isim ve soy isminiz ile Zoom’a giriş yaptığınızdan lütfen emin olunuz.";
        }  //Ğ
