    ...
    public partial class sifre : MetroFramework.Forms.MetroForm
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                MessageBox.Show("Değişiklikerin uygulanması için program yeniden başlatılacaktır","Değişikliklerin Uygulanması",MessageBoxButtons.OK,MessageBoxIcon.Information);
                Application.Restart();
            }
            else
            {
